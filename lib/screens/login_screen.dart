...
// 4.1 Controllers
  ...
  void _onLogin() {
    ...
    final email = emailCtrl.text.trim(); //trim elimina espacios en blanco
  ...
  //1.2)Listeners (0yentes/Chsimosos)

  @override
  void initState(){ //metodo como va a iniciar la presentacion
    super.initState();
            ...
            child: Column(
              children: [
                SizedBox(
                  ...
                  TextField(
                    //4.8 Enlazar controller al texField
                    controller: emailCtrl,
                    //1.3 Asignar FocusNode al texfield
                ...
                TextField(
                  ...
                  //1.3 asignar Focus Node al textield
